...
<br>
🔺 <strong>Nível de abstração:</strong><br>
...
<br>
🔺 <strong>Paradigma de programação:</strong><br>
...
<br>
🔺 <strong>Linguagens classificadas pela arquitetura da aplicação:</strong><br>
Desktop: C, C++, Object Pascal, Java, etc.<br>
Web: PHP, Ruby, Javascript, Java, etc.<br>
<br>
🔺 <strong>Tipo de execução:</strong><br>
